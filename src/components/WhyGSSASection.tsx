...
const pillars = [
  {
    key: 'sales',
    title: 'In the Market',
    description: 'We sell smart, act fast, and deliver consistently. Our local teams know every forwarder, every route, every opportunity in Korea.',
    icon: (
  ...
  },
  {
    key: 'intelligence',
    title: 'On the Ground',
    description: 'Trade flow analysis, seasonal forecasting, competitive benchmarking, and regulatory intelligence — updated weekly.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.2}>
  ...
  },
  {
    key: 'digital',
    title: 'In the Cloud',
    description: 'Real-time dashboards, API connectivity, digital booking platforms, and performance analytics at your fingertips.',
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.2}>
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 lg:gap-16">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.05] tracking-tight max-w-2xl">
                We Think Like an Airline. We Act Like Your Team.
              </h2>
              <p className="text-base md:text-lg text-white/40 leading-relaxed max-w-md font-light">
                A GSSA is not a middleman. We are your dedicated commercial team in Korea — selling your capacity, managing your brand, and growing your revenue as if it were our own business.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative grid md:grid-cols-2 gap-0">
              <div className="p-8 md:p-12 lg:p-16 border-b md:border-b-0 md:border-r border-white/[0.06]">
                <span className="text-[#FF6B35] text-sm font-semibold uppercase tracking-wider">What We Do</span>
                <h3 className="text-2xl md:text-3xl font-bold text-white mt-4 mb-6 leading-tight">
                  Your Cargo Department in Korea
                </h3>
                <p className="text-white/50 leading-relaxed">
                  We handle everything — from cargo sales and pricing to capacity management and customer relationships. Airlines gain a fully operational commercial team in Korea without the overhead of building one.
                </p>
              </div>
              <div className="p-8 md:p-12 lg:p-16">
                <span className="text-[#4A90D9] text-sm font-semibold uppercase tracking-wider">Why It Matters</span>
                <h3 className="text-2xl md:text-3xl font-bold text-white mt-4 mb-6 leading-tight">
                  Measurable Results
                </h3>
                <p className="text-white/50 leading-relaxed">
                  Our airline partners see immediate impact: increased load factors, stronger forwarder relationships, and real-time market intelligence that drives revenue growth. 10+ years of track record in Korea, with leadership bringing 38+ years of airline cargo experience.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {pillars.map((pillar, index) => (
            ...
            >
              ...
              <div className={`absolute -top-20 -right-20 w-40 h-40 bg-gradient-radial ${pillar.gradient} rounded-full blur-3xl opacity-0 motion-safe:group-hover:opacity-100 transition-opacity duration-700`} />

              <div className="relative p-6 md:p-8">
                <div
                  className="w-14 h-14 rounded-xl flex items-center justify-center mb-6 transition-colors duration-500"
                  style={{ backgroundColor: `${pillar.accent}10`, color: pillar.accent, border: `1px solid ${pillar.accent}20` }}
                >
                  {pillar.icon}
                </div>
                ...
                <div className="mt-6 h-px w-0 motion-safe:group-hover:w-full transition-all duration-700 ease-out" style={{ backgroundColor: pillar.accent }} />
              </div>
            </motion.div>
          ))}
        </div>
