...
const services = [
  ...
  },
  {
    ...
    name: 'Goodman Aero Solutions (MRO)',
    tagline: 'Completing Expertise',
    description: 'Total solutions supporting safe aircraft operations including AOG support, parts sale/exchange, and consignment.',
  },
];
  ...
  return (
    <section id="services" className="min-h-screen flex items-center section-md bg-[#070612] relative z-10 py-32 overflow-hidden">
      ...
      <div className="container relative z-10" ref={containerRef}>
        <motion.div style={{ y: yParallax }} className="mb-24 md:mb-32 max-w-6xl mx-auto">
          <motion.div
          ...
          >
            <h2 className="display-serif text-white text-5xl md:text-6xl lg:text-7xl tracking-tight flex-1">
              Beyond GSSA — Full Logistics Capability
            </h2>
