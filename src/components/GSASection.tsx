...
const partners = [
  { code: 'WS', name: 'WestJet Cargo (GSA) - Canada, USA, Mexico, Europe' },
  { code: 'O3', name: 'ShunFeng Airlines (CSA) - China, SE Asia, Japan, Korea' },
  { code: 'BX', name: 'Air Busan (GSA) - China, Japan, SE Asia' },
  { code: 'M0', name: 'Aero Mongolia (GSA) - Mongolia' },
  { code: 'SU', name: 'Aeroflot (CSA) - Russia, CIS, Europe, USA' },
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex-1 md:max-w-lg">
                ...
                From flag carriers to specialty freighters, we deliver dedicated cargo sales representation across every segment.
                </p>
            </div>
          </motion.div>
          ...
          >
            <Link href="/network-solutions" className="group inline-flex items-center justify-center px-10 py-5 rounded-full bg-white text-[#070612] text-sm font-bold uppercase tracking-wider hover:bg-[#FF6B35] hover:text-white transition-all duration-300 focus-visible:ring-2 focus-visible:ring-[#FF6B35]/50 focus-visible:outline-none">
              <span>View Our Airline Partners</span>
              <svg
