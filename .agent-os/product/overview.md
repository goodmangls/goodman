...
1. **Marketing Website** (Live) - Full bilingual (EN/KO) marketing site with 5 public pages, contact form, and floating connect widget
2. **Partner Portal** (Auth Complete) - NextAuth 5 authentication with registration, email verification, password reset, and role-based access. Dashboard is scaffolded.
...
6. **Digital Partner Portal**: Self-service quote and tracking for B2B partners

## Success Metrics

- Partner registration and activation rate
- Quote request volume and response time
- Shipment tracking usage
- Partner portal active users (monthly)
- Lead conversion rate from website
